...
namespace bramblefore
{
    ...
    void PlantTrapAnimationLayer::move(const Context &, const sf::Vector2f & t_move)
    {
    ...
    const sf::IntRect PlantTrapAnimationLayer::textureRect(const std::size_t frame) const noexcept
    {
        sf::IntRect rect;
    ...
    void PlantTrapAnimationLayer::dumpInfo() const
    {
        std::clog << "\tPlant Trap Animation Layer: x" << m_anims.size() << '\n';
    }
