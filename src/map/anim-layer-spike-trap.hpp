#ifndef ANIM_LAYER_SPIKE_TRAP_HPP_INCLUDED
#define ANIM_LAYER_SPIKE_TRAP_HPP_INCLUDED
//
// anim-layer-spike-trap.hpp
//
...
namespace bramblefore
{
    ...
    struct SpikeTrapAnim
    {
        explicit SpikeTrapAnim(const sf::Texture & t_texture)
            : is_resetting{ false }
            , is_springing{ false }
    ...
    class SpikeTrapAnimationLayer
        : public ITileLayer
        , public IHarmCollisionOwner
    {
      public:
        SpikeTrapAnimationLayer(Context & t_context, const std::vector<sf::FloatRect> & t_rects);
        virtual ~SpikeTrapAnimationLayer() override;
      ...
      private:
        ...
        std::vector<SpikeTrapAnim> m_anims;
    };

} // namespace bramblefore

#endif // ANIM_LAYER_SPIKE_TRAP_HPP_INCLUDED
