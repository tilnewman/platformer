...
namespace bramblefore
{
    ...
    void SpikeTrapAnimationLayer::move(const Context &, const sf::Vector2f & t_move)
    {
    ...
    const sf::IntRect SpikeTrapAnimationLayer::textureRect(const std::size_t frame) const noexcept
    {
        sf::IntRect rect;
